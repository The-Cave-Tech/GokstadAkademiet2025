...
export default function UserBlogPage() {
  ...
  const handleDelete = async (id: string) => {
    try {
      ...
      if (success) {
        ...
        setBlogPosts((prevBlogPosts) => prevBlogPosts.filter((post) => post.documentId !== id));
      }
    } catch (error) {
  ...
  return (
    <section className="min-h-screen p-6 sm:p-8 md:p-10" style={{ backgroundColor: Theme.colors.background }}>
      {/* Success Message */}
      {successMessage && (
        <div
      ...
      <section className="p-6 sm:p-8">
        ...
        {isLoading ? (
          ...
          // No Blog Posts Found
          <div className="text-center my-16 p-8 rounded-lg" style={{ backgroundColor: "rgba(188, 170, 164, 0.2)" }}>
            <svg
              ...
              >
                {blogPosts.map((post, index) => (
                  <tr
                    ...
                    style={{
                      backgroundColor: index % 2 === 0 ? "transparent" : "rgba(188, 170, 164, 0.08)",
                    }}
                    onMouseOver={(e) => (e.currentTarget.style.backgroundColor = Theme.colors.surfaceHover)}
                    onMouseOut={(e) =>
                      (e.currentTarget.style.backgroundColor =
                        index % 2 === 0 ? "transparent" : "rgba(188, 170, 164, 0.08)")
                    }
                  >
                    {/* Image */}
                    ...
                    <td className="px-4 py-4">
                      ...
                      {post.summary && (
                        <div className="mt-1 truncate max-w-xs" style={{ color: Theme.colors.text.secondary }}>
                          {post.summary}
                        </div>
                      )}
                    </td>
                    ...
                    <td className="px-4 py-4 whitespace-nowrap">
                      <div className="flex space-x-2">
                        <button
                          ...
                          onMouseOver={(e) => (e.currentTarget.style.backgroundColor = Theme.colors.errorHover)}
                          onMouseOut={(e) => (e.currentTarget.style.backgroundColor = Theme.colors.error)}
                        >
                          Delete
                        </button>
                        <Link
                          ...
                          onMouseOver={(e) => (e.currentTarget.style.backgroundColor = Theme.colors.infoHover)}
                          onMouseOut={(e) => (e.currentTarget.style.backgroundColor = Theme.colors.info)}
                        >
                          Edit
                        </Link>
                        <Link
                          ...
                          onMouseOver={(e) => (e.currentTarget.style.backgroundColor = Theme.colors.successHover)}
