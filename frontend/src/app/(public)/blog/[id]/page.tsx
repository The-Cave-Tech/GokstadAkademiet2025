            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="mt-8 pt-6 border-t border-gray-100 text-xs text-gray-500 space-y-1">
                {blogPost.publishedAt && (
                  <p>Publisert: {formatDate(blogPost.publishedAt)}</p>
                )}
                {blogPost.createdAt && (
                  <p>Opprettet: {formatDate(blogPost.createdAt)}</p>
                )}
                {blogPost.updatedAt && (
                  <p>Sist oppdatert: {formatDate(blogPost.updatedAt)}</p>
                )}
              </div>
            </div>
          </div>
            ...
            {blogPost.content && (
              <div className="mb-8 prose max-w-none">
                {typeof blogPost.content === "object" ? (
                  <ProjectContent content={blogPost.content} />
                ) : (
