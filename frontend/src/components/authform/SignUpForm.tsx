...
export function SignUpForm() {
  ...
  const labelClass = "text-base font-roboto font-normal text-typographyPrimary flex items-center gap-1";
  const getInputStateClass = (field: SignUpValidationErrorKeys) => {
    ...
    if (isSubmitted && !formValues[field]) return "border-danger focus:ring-danger-hover"; 
    if (clientError || (isSubmitted && serverError)) return "border-danger focus:ring-danger-hover"; 
        ...
        <Card className="w-full sm:w-[26rem] max-w-full mx-auto shadow-lg">
          <CardHeader className="pb-3 sm:pb-4">
            <section className="flex flex-col items-center gap-2 sm:gap-4">
              ...
              <h1 className="text-section-title-medium font-semibold text-typographyPrimary">Opprett Konto</h1>
              <div className="flex gap-1 text-captions-big text-typographyPrimary">
          ...
          <CardBody>
            <div className="text-center mb-3 sm:mb-4">
              {formState.strapiErrors ? (
                <p className="text-danger text-xs sm:text-sm font-medium animate-fade-in">{formState.strapiErrors.message}</p>
              ) : isSubmitted && Object.values(formValues).some((val) => !val) ? (
                <p className="text-danger text-xs sm:text-sm font-medium animate-fade-in">Alle felt merket med * er obligatoriske</p>
              ) : null}
            </div>
            ...
            <fieldset className="space-y-3 sm:space-y-5">
              ...
              <section>
                <label htmlFor="username" className={`${labelClass} text-body-small `}>
                ...
                <input
                  ...
                  id="username"
                  name="username"
                  className={`${inputClass} ${getInputStateClass("username")} text-body-small`}
              ...
              <section>
                <label htmlFor="email" className={`${labelClass} text-body-small`}>
                ...
                <input
                  ...
                  id="email"
                  name="email"
                  className={`${inputClass} ${getInputStateClass("email")} text-body-small`}
              ...
              <section>
                <label htmlFor="password" className={`${labelClass} text-body-small`}>
                ...
                <div className="relative">
                  <input
                    ...
                    id="password"
                    name="password"
                    className={`${inputClass} ${getInputStateClass("password")} text-body-small`}
              ...
              <section>
                <label htmlFor="repeatPassword" className={`${labelClass} text-body-small`}>
                ...
                <div className="relative">
                  <input
                    ...
                    id="repeatPassword"
                    name="repeatPassword"
                    className={`${inputClass} ${getInputStateClass("repeatPassword")} text-body-small`}
            ...
            <fieldset className="pt-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex-grow text-body-small text-typographyPrimary">
